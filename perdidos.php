...
<main style="max-width: 600px; margin: auto;">
    ...
    <article>
        ...
        <section style="background-color: #313092; padding: 20px; border-radius: 10px; margin-top: 30px;">
            ...
            <?php else: ?>
                <div style="background-color: #ffcccc; color: #b30000; padding: 15px; border-radius: 8px; text-align: center; border: 1px solid #b30000;">
                    <p><strong>Ops!</strong> Você precisa estar logado para poder publicar.</p>
                    <p style="font-size: 11px;">Faça login na <a href="index.php" style="color: #dd7c0e; font-weight: bold;"> Página Inicial</a> para continuar.</p>
                </div>
            <?php endif; ?>
        </section>
    </article>
