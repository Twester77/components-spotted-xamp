...
<head>
    ...
    <style>
        body { background: #0a0a0ad0; color: #fff; font-family: -apple-system, BlinkMacSystemFont, system-ui, sans-serif; display: flex; justify-content: center; align-items: center; min-height: 100vh; padding: 0 10px; margin: 20px auto; }
        ...
        .btn { background: #70cde4; color: #000; padding: 15px 30px; border-radius: 8px; text-decoration: none; font-weight: bold; font-size: 16px; border: none; cursor: pointer; display: inline-block; margin-top: 20px; max-width: 100%; box-shadow: 0 0 15px rgba(112, 205, 228, 0.3); }
    </style>
</head>
<body>
    <div class="card">
