<?php
/**
 * escrever-depoimento-modal.php – Retorna apenas o HTML do formulário de depoimento (sem header/footer)
 */
...
if ($destinatario_id <= 0) {
    echo '<p style="text-align:center; color:#ff6b6b;">Destinatário inválido.</p>';
    exit;
}
...
if (!$destinatario) {
    echo '<p style="text-align:center; color:#ff6b6b;">Destinatário não encontrado.</p>';
    exit;
}

// Impede auto-depoimento
if ($_SESSION['usuario_id'] == $destinatario_id) {
    echo '<p style="text-align:center; color:#ff6b6b;">Você não pode escrever um depoimento para si mesmo.</p>';
    exit;
}
?>
<div class="depoimento-form-container">
    ...
    <form action="processa-depoimento.php" method="POST" id="form-depoimento-modal">
        <!-- CSRF Token -->
        ...
        <div class="campo-grupo">
            ...
            <textarea name="mensagem" id="mensagem-modal" rows="6" maxlength="500" placeholder="Escreva um depoimento sincero..." required></textarea>
        ...
        <div class="botoes-rodape">
            ...
            <button type="button" class="btn-secundario" id="btn-cancelar-modal-depoimento">Cancelar</button>
        </div>
    </form>
</div>