...
<main class="container-feed">
    ...
    <section class="sessao-publicar" id="fofocar">
        ...
        <h3 style="color: #ffbc00;">Opino ou prefiro não opinar?</h3>
        ...
        <form action="enviar-comentario.php" method="POST" class="form-fofoca">
            ...
            if ($exibir_nome): ?>
                <button type="submit" style="background: #ffbc00; color: #000; border: none; padding: 12px; border-radius: 8px; width: 100%; font-weight: bold;">Lançar Fofoca como @<?php echo htmlspecialchars($exibir_nome); ?> 🚀</button>
            <?php else: ?>
