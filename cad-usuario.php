...
<main style="max-width: 500px; margin: 40px auto; padding: 20px; background: rgba(255,255,255,0.05); border-radius: 15px; backdrop-filter: blur(10px); border: 1px solid rgba(255,255,255,0.1);">
    ...
    <h2 style="text-align: center; color: #ffbc00; margin-bottom: 20px;"> Criar sua conta na Fenda</h2>
    ...
    <form action="processa-cadastro.php" method="POST" style="display: flex; flex-direction: column; gap: 15px;">
        ...
        <div class="input-group">
            ...
            <input type="text" name="nome" placeholder="Ex: Leonardo Rodrigues" required style="width: 100%; padding: 10px; border-radius: 5px; border: none; margin-top: 5px;">
        </div>
    ...
    <input type="email" 
           name="email" 
           placeholder="ex: 87826@unifev.edu.br" 
        ...
        <p style="text-align: center; font-size: 14px; color: #eee;">
            Já tem conta? <a href="index.php" style="color: #ffbc00; font-weight: bold;">Faça Login</a>
        </p>
    </form>
</main>
