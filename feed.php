...
$sql = "SELECT m.*, u.username, u.nome FROM mensagens m LEFT JOIN usuarios u ON m.usuario_id = u.id";
...
<div class="user-info" style="padding: 20px; text-align: center; background: rgba(0,0,0,0.1); border-bottom: 2px solid #ff7011;">
    ...
    <div style="margin-top: 10px;">
        <span style="color: white; font-weight: bold;">Olá, <?php echo $nome_exibicao; ?>!</span>
    </div>
</div>
            ...
            <div class="card-header">
                <span class="category-tag">
                    ...
                    <small style="margin-left: 10px;">
                        ...
                        <?php else: ?>
                            <span style="opacity: 0.7; color: #fff;">🕵️ Estudante</span>
                        <?php endif; ?>
                    </small>
                </span>
