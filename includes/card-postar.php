<section id="postar" class="main-novo-post" style="margin-bottom: 40px !important;">
    <div class="form-container">
        ...
        <form action="enviar-post.php" method="POST" enctype="multipart/form-data">
            <textarea name="mensagem" placeholder="Sussurre algo para a Fenda..." required maxlength="600"></textarea>
            ...
            <select name="categoria" id="categoria" style="background: #1a1a1a; color: #fff; border: 1px solid var(--dourado); border-radius: 10px; padding: 10px; margin-bottom: 15px; display: block; width: 100%;">
        ...
        </form> <div style="margin-top: 10px; text-align: center; font-size: 12px; opacity: 0.8;">
