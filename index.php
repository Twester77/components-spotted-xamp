...
<main style="max-width: 800px; margin: auto; padding: 20px;">
    ...
    <p> Lembrando que NÃO NOS RESPONSABILIZAMOS por quaisquer opiniões do usuário ou tomamos qualquer partido político, somos somente mensageiros </p>
        ...
        <blockquote style="border-left: 4px solid #cc420c; padding-left: 15px; margin: 20px 0; font-style: italic;">
        ...
        <p style="font-weight: bold; text-align: center; color: #ffbc00;"> 
         E por último porém não menos importante: Usem camisinha, não construam casa no terreno da sogra, invistam em Bitcoin, NÃO é NÃO, bebam água e é claro, divirtam-se! </p>  
    </article>

    <article style="text-align: center; margin-top: 40px;">
        <div style="display: flex; gap: 15px; justify-content: center;">
            <img src="imagensfoto/Campus Centro.jpg" alt="UNIFEV- Câmpus Centro" style="width: 45%; border-radius: 8px;">
            <img src="imagensfoto/Cidade Universitaria.jpg" alt="Cidade Universitária" style="width: 45%; border-radius: 8px;">
        </div>
