...
if ($limite > 5) {
    ...
    echo '  <button id="btn-marcar-todas-lidas" class="btn-fenda-padrao" style="font-size:0.85rem; padding:6px 14px; background:rgba(255,188,0,0.12); color:#ffbc00; border:1px solid rgba(255,188,0,0.15); border-radius:30px; cursor:pointer;">';
