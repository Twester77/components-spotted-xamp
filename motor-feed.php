...
// 🔥 Instancia o B2 UMA ÚNICA VEZ antes do loop
try {
    $b2 = B2Client::getInstance();
} catch (Exception $e) {
    error_log('[FEED] Falha ao instanciar B2: ' . $e->getMessage());
    $b2 = null;
}
...
while ($linha = mysqli_fetch_assoc($resultado)) {
    ...
    if ($categoria_atual === 'anonimo') {
        $avatar = 'uploads/ui/anonimo-default.webp';
    ...
    <article class="spotted-card <?php echo $categoria_atual; ?> <?php echo $vibe_post; ?> <?php echo $classe_admin; ?>"
        ...
        <div class="user-info-post">
            <img src="<?php echo $avatar; ?>"
                class="avatar-p"
                decoding="async"
                onerror="this.src='uploads/ui/default.webp';">
